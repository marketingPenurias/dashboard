...
// react-force-graph-2d toca `window`/canvas — no puede evaluarse durante
// SSR. `next/dynamic({ ssr: false })` se sustituye por `lazy()` +
// `Suspense` + un guard de montaje: el import perezoso solo se dispara
// tras el primer render en cliente (`mounted === true`), igual que hacía
// el flag `ssr: false` en Next.
