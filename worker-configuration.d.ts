/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: e954ace3f0902230e6827ee38eec334e)
// Runtime types generated with workerd@1.20251217.0 2026-08-26 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./workers/app");
	}
	interface Env {
		SUPABASE_URL: "https://cfxpwsexxwcxogwuykue.supabase.co";
		SUPABASE_PUBLISHABLE_KEY: "sb_publishable_c-vtNNGaW7lATIjegGk5zg_rC4hVZXI";
		SUPABASE_SECRET_KEY: string;
		ANALYTICS_JWT_SECRET: string;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SUPABASE_URL" | "SUPABASE_PUBLISHABLE_KEY" | "SUPABASE_SECRET_KEY" | "ANALYTICS_JWT_SECRET">> {}
}
